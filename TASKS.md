...
| T014-1 | 实现单元测试 | 🔄 进行中 | T014-1-1, T014-1-2, T014-1-3, T014-1-4, T014-1-5, T014-1-6 | T004 | 2025-Q2 |
...
| T014-5 | 集成Cypress测试报告 | ⏳ 待开始 | 无 | T014-2 | 2025-Q2 |
| T014-6 | 编写测试文档 | 🔄 进行中 | 无 | T014-1, T014-2 | 2025-Q2 |
| T015 | 第三方开发者Portal | ✅ 已完成 | T015-1, T015-2, T015-3 | T005, T008 | 已完成 |
| T015-1 | 实现开发者控制台UI | ✅ 已完成 | 无 | T005, T007-1 | 已完成 |
| T015-2 | 实现API上传和管理功能 | ✅ 已完成 | 无 | T015-1 | 已完成 |
| T015-3 | 集成服务启用/禁用功能 | ✅ 已完成 | 无 | T015-2 | 已完成 |
