...
**后端服务器**
- 地址：`10.107.121.51:8000`
- API接口：`http://10.107.121.51:8000/api/v1`
- API文档：`http://10.107.121.51:8000/docs`
...
# 配置后端连接
echo "REACT_APP_API_BASE_URL=http://10.107.121.51:8000" > .env
...
// 环境配置
const API_CONFIG = {
  baseURL: 'http://10.107.121.51:8000',
  apiPrefix: '/api/v1',
  timeout: 30000
};
...
# 2. 配置环境变量
cat > .env << EOF
REACT_APP_API_BASE_URL=http://10.107.121.51:8000
...
- [API文档](http://10.107.121.51:8000/docs) - Swagger UI
